...
(
    ...
    CONSTRAINT fk_shows_to_pets FOREIGN KEY (pet_id) REFERENCES pets (id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS pets_shows
(
    ...
    CONSTRAINT fk_pets_awards_to_awards FOREIGN KEY (show_id) REFERENCES shows (id) ON DELETE CASCADE,

    PRIMARY KEY (pet_id, show_id)
);
